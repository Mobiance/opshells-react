    ...
    return (
        <div className="flex gap-y-10 flex-col">
            <div className="flex flex-row">
                ...
                <img src="/educated.jpg" alt="educated" width={600} height={300} />
            </div>
            <div className="flex flex-row">
                <img src="/marketing.jpg" alt="marketing" width={600} height={300} />
            ...
            <div className="flex flex-row">
                ...
                <img src="/medicare.jpg" alt="medicare" width={600} height={300} />
            </div>
        </div>
    );
};
